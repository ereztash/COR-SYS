    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 pt-24 pb-16 max-w-3xl">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button onClick={() => router.push("/growth/wizard")} className="gap-2">
        ...
        {plans.length === 0 ? (
          ...
          <div className="space-y-3">
            {plans.map((plan) => (
              <Card key={plan.id} className="cursor-pointer hover:shadow-md transition-shadow" onClick={() => router.push(`/growth/plans/${plan.id}`)}>
