...
import { TIERS } from "@/lib/growth/pricingTiers";
...
export default function Page() {
  ...
  useEffect(() => {
    if (user) router.push("/growth/dashboard");
  }, [user, router]);
      ...
      <section className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden px-4 pt-16">
        ...
        <motion.div {...mp} className="relative z-10 max-w-3xl text-center">
          ...
          <div className="flex flex-col items-center gap-2">
            <Button size="lg" onClick={() => router.push("/growth/wizard")} className="gap-2 text-lg px-10 py-6 rounded-xl cta-warm shadow-lg">
      ...
      <section className="container mx-auto px-4 py-12">
        <Card className="max-w-2xl mx-auto border-dashed border-2 border-amber-500/30 bg-amber-500/5">
          <CardContent className="p-8 text-center space-y-4">
            ...
            <Button onClick={() => router.push("/growth/wizard")} className="gap-2 cta-warm">
