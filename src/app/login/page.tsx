    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm text-center">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-black text-white text-2xl" style={{ fontFamily: 'Heebo, sans-serif' }}>
            COR-SYS
          </span>
        </div>
        ...
        <form action={signInWithGoogle}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-bold text-base transition-colors border border-slate-200"
          >
