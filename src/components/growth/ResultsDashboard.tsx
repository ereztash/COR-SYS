...
import AdaptiveTabNav from "@/components/growth/AdaptiveTabNav";

const BrandDiagnosticTab = lazy(() => import("@/components/growth/BrandDiagnosticTab"));
const PlanningTab = lazy(() => import("@/components/growth/PlanningTab"));
const ContentTab = lazy(() => import("@/components/growth/ContentTab"));
const AnalyticsTab = lazy(() => import("@/components/growth/AnalyticsTab"));
const AiCoachChat = lazy(() => import("@/components/growth/AiCoachChat"));
const WhatsAppTemplatesPanel = lazy(() => import("@/components/growth/WhatsAppTemplatesPanel"));
const StylomeExtractor = lazy(() => import("@/components/growth/StylomeExtractor"));
const SalesTab = lazy(() => import("@/components/growth/SalesTab"));
const PricingIntelligenceTab = lazy(() => import("@/components/growth/PricingIntelligenceTab"));
const RetentionGrowthTab = lazy(() => import("@/components/growth/RetentionGrowthTab"));
import { useMetaAuth } from "@/hooks/growth/useMetaAuth";
import { useLanguage } from "@/i18n/LanguageContext";
import { useUserProfile } from "@/contexts/growth/UserProfileContext";
import { useReducedMotion } from "@/hooks/growth/useReducedMotion";
import { FunnelResult } from "@/types/growth/funnel";
import { getTabConfig } from "@/lib/growth/adaptiveTabRules";
import { funnelStageColors, chartColorPalette } from "@/lib/growth/colorSemantics";
import { getIsraeliToolsSummary, getToolsForChannel } from "@/lib/growth/toolRecommendations";
import { getIndustryBenchmarks } from "@/lib/growth/industryBenchmarks";
import { calculateHealthScore, getHealthScoreColor } from "@/lib/engines/growth/healthScoreEngine";
import { getSocialProof } from "@/lib/growth/socialProofData";
import { calculateRoi } from "@/lib/growth/roiCalculator";
import { calculateCostOfInaction } from "@/lib/engines/growth/costOfInactionEngine";
import { getEventsForField } from "@/lib/growth/israeliMarketCalendar";
import { generateCLGStrategy } from "@/lib/engines/growth/clgEngine";
import { generateRetentionFlywheel } from "@/lib/engines/growth/retentionFlywheelEngine";
import { personalizeResult } from "@/lib/engines/growth/funnelEngine";
import { buildUserKnowledgeGraph, StylomeVoice } from "@/lib/engines/growth/userKnowledgeGraph";
import { calculateValueScore } from "@/lib/engines/growth/hormoziValueEngine";
import { HormoziValueCard } from "@/components/growth/HormoziValueCard";
import { DifferentiationResult } from "@/types/growth/differentiation";
import { useSavedPlans } from "@/hooks/growth/useSavedPlans";
import { useAchievements } from "@/hooks/growth/useAchievements";
import { useFeatureGate } from "@/hooks/growth/useFeatureGate";
