...
import { PhaseQuestion, DifferentiationFormData, HiddenValueScore, HiddenValueType, CompetitorArchetype, CompetitorArchetypeId, BuyingCommitteeRole, BuyingCommitteeRoleId, ClaimExample } from "@/types/growth/differentiation";
import { HIDDEN_VALUES, COMPETITOR_ARCHETYPES as ARCHETYPE_DEFS, BUYING_COMMITTEE_ROLES as ROLE_DEFS } from "@/lib/engines/growth/differentiationKnowledge";
