...
import { useModuleStatus, ModuleStatus } from "@/hooks/growth/useModuleStatus";
    ...
    return (
      ...
      >
        <Card
          ...
          onClick={() => router.push("/growth" + mod.route)}
          onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") router.push("/growth" + mod.route); }}
        >
