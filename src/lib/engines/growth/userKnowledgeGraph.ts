...
import { DifferentiationResult, MechanismStatement, TradeoffDeclaration, HiddenValueScore, CompetitorArchetype, BuyingCommitteeRoleId } from "@/types/growth/differentiation";
