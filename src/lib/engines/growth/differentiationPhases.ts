...
import { PhaseConfig, PhaseId, PhaseQuestion, DifferentiationFormData, detectMarketMode } from "@/types/growth/differentiation";
...
const PHASE_3_QUESTIONS: PhaseQuestion[] = [
  ...
  { id: "hiddenValues", type: "slider", required: true,
    label: { he: "מה באמת משפיע על ההחלטה של הלקוח?", en: "What actually drives your customer's decision?" },
    helperText: { he: "דרגו כל שאלה — לא מה הלקוחות אומרים, אלא מה באמת משנה להם", en: "Rate each question — not what customers say, but what actually matters to them" } },
